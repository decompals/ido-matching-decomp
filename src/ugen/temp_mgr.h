...
function make_new_temp(size: integer): pointer; external;
function find_free_temp(size: integer): pointer; external;
...
procedure spill_to_temp(arg0: registers; size: integer); external;
