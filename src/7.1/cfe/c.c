...
#endif
#if YYMAXDEPTH > 0
extern int yy_yys[YYMAXDEPTH], *yys = yy_yys;
extern YYSTYPE yy_yyv[YYMAXDEPTH], *yyv = yy_yyv;
...
case 1:
# line 294 "src/7.1/cfe/c.y"
{
		if (debug_arr['y'] > 0) {
			fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-0].identifier.unk_04->name, yypvt[-0].identifier.unk_00);
		}
		yyval.node = make(Identifier, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
	} break;
case 7:
# line 314 "src/7.1/cfe/c.y"
{ yyval.node = yypvt[-1].node; } break;
case 9:
# line 319 "src/7.1/cfe/c.y"
{ yyval.node = make(Index_expr, yypvt[-2].location, yypvt[-3].node, yypvt[-1].node); } break;
case 10:
# line 321 "src/7.1/cfe/c.y"
{ 
...
case 19:
# line 343 "src/7.1/cfe/c.y"
{
			LINK_PUSH_BACK(yyval.node, yypvt[-0].node);
		} break;
case 21:
# line 350 "src/7.1/cfe/c.y"
...
case 25:
# line 361 "src/7.1/cfe/c.y"
{ yyval.node = make(Sizeof_expr, yypvt[-1].identifier.unk_00, yypvt[-0].node); } break;
case 26:
# line 362 "src/7.1/cfe/c.y"
{ cur_lvl->unk_04 = 1; } break;
case 27:
# line 362 "src/7.1/cfe/c.y"
{ yyval.node = make(Sizeof_expr, yypvt[-4].identifier.unk_00, yypvt[-2].node); } break;
case 28:
# line 363 "src/7.1/cfe/c.y"
{ yyval.node = make(Alignof_expr, yypvt[-1].identifier.unk_00, yypvt[-0].node); } break;
case 29:
# line 364 "src/7.1/cfe/c.y"
{ cur_lvl->unk_04 = 1; } break;
case 30:
# line 364 "src/7.1/cfe/c.y"
{ yyval.node = make(Alignof_expr, yypvt[-4].identifier.unk_00, yypvt[-2].node); } break;
case 31:
# line 365 "src/7.1/cfe/c.y"
{ yyval.node = make(Classof_expr, yypvt[-1].identifier.unk_00, yypvt[-0].node); } break;
case 32:
# line 366 "src/7.1/cfe/c.y"
{ cur_lvl->unk_04 = 1; } break;
case 33:
# line 366 "src/7.1/cfe/c.y"
{ yyval.node = make(Classof_expr, yypvt[-4].identifier.unk_00, yypvt[-2].node); } break;
case 34:
# line 370 "src/7.1/cfe/c.y"
...
case 129:
# line 774 "src/7.1/cfe/c.y"
{
			yyval.declspec.unk_00 = make(Identifier, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
			yyval.declspec.unk_04 = 0;
			yyval.declspec.unk_08 = 0;
			yyval.declspec.unk_0C = yypvt[-0].identifier.unk_08;
		} break;
case 130:
# line 784 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-1].identifier.unk_04->name, yypvt[-1].identifier.unk_00);
			}
			cur_lvl = (UnkChi*)get_link_elem(B_10020F00);
			cur_lvl->unk_04 = 1;
			cur_lvl->unk_10 = 1;
...
case 131:
# line 795 "src/7.1/cfe/c.y"
{
			STRUCT_TYPE(yyval.node).sname = make(Id_decl, yypvt[-4].identifier.unk_08, yypvt[-4].identifier.unk_04);
...
case 134:
# line 820 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-0].identifier.unk_04->name, yypvt[-0].identifier.unk_00);
			}
			STRUCT_TYPE(yyval.node).sname = make(Id_decl, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
			cur_lvl->unk_04 = 1;
			if (B_10020F04 == 0) {
                tree_handle = cur_lvl->unk_14;
            }
...
case 135:
# line 834 "src/7.1/cfe/c.y"
{
			if (B_10020F04 == 0) {
                cur_lvl->unk_14 = tree_handle;
                tree_handle = general_handle;
            }
            yyval.node = make(Struct_type, yypvt[-0].identifier.unk_00, STRUCT_INFO_STRUCT);
            cur_lvl->unk_04 = 0;
		} break;
case 136:
# line 843 "src/7.1/cfe/c.y"
{
			if (B_10020F04 == 0) {
                cur_lvl->unk_14 = tree_handle;
                tree_handle = general_handle;
            }
            yyval.node = make(Struct_type, yypvt[-0].identifier.unk_00, STRUCT_INFO_UNION);
            cur_lvl->unk_04 = 0;
		} break;
case 137:
# line 854 "src/7.1/cfe/c.y"
{ error(0x20097, LEVEL_DEFAULT, curloc); } break;
case 140:
# line 861 "src/7.1/cfe/c.y"
{
			LINK_PUSH_BACK(yyval.node, yypvt[-0].node);
		} break;
case 141:
# line 867 "src/7.1/cfe/c.y"
{ cur_lvl->unk_04 = 0; } break;
case 142:
...
case 158:
# line 973 "src/7.1/cfe/c.y"
{
			ENUM_TYPE(yyval.node).ename = make(Id_decl, yypvt[-5].identifier.unk_08, yypvt[-5].identifier.unk_04);
			ENUM_TYPE(yyval.node).literals = yypvt[-2].list.first;
			if (yypvt[-1].location != -1) {
				error(0x2007E, LEVEL_DEFAULT, yypvt[-1].location);
			}
...
case 159:
# line 984 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-0].identifier.unk_04->name, yypvt[-0].identifier.unk_00);
			}
			ENUM_TYPE(yyval.node).ename = make(Id_decl, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
			cur_lvl->unk_04 = 1;
			if (B_10020F04 == 0) {
                tree_handle = cur_lvl->unk_14;
            }
...
case 160:
# line 997 "src/7.1/cfe/c.y"
{ yyval.location = -1; } break;
case 162:
# line 1003 "src/7.1/cfe/c.y"
{
			if (B_10020F04 == 0) {
                cur_lvl->unk_14 = tree_handle;
                tree_handle = general_handle;
            ...
            cur_lvl->unk_04 = 0;
            yyval.node = make(Enum_type, yypvt[-0].identifier.unk_00);
		} break;
case 163:
# line 1014 "src/7.1/cfe/c.y"
{ yyval.list.first = yyval.list.last = yypvt[-0].node; } break;
case 164:
# line 1016 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 165:
# line 1027 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-0].identifier.unk_04->name, yypvt[-0].identifier.unk_00);
			}
			yyval.node = make(Id_decl, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
		} break;
case 166:
# line 1034 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-2].identifier.unk_04->name, yypvt[-2].identifier.unk_00);
			}
			yyval.node = make(Id_decl, yypvt[-2].identifier.unk_08, yypvt[-2].identifier.unk_04);
			ID_DECL(yyval.node).init_value = yypvt[-0].node;
		} break;
case 167:
# line 1045 "src/7.1/cfe/c.y"
{
			yyval.declspec.unk_00 = NULL;
...
# line 1078 "src/7.1/cfe/c.y"
{
			...
			cur_lvl->unk_04 = 1;
			if (yypvt[-0].identifier.unk_00 != 0 && cur_lvl->unk_10 == 0 && cur_lvl->unk_08 == 1) {
				UnkBeta* spD8;
				mk_parse_symb(yypvt[-0].identifier.unk_04, 0, B_10020F04);
				spD8 = (UnkBeta*)get_link_elem(B_10020F08);
				spD8->unk_04 = yypvt[-0].identifier.unk_04;
				spD8->link.next = B_10020F08->used_list;
				B_10020F08->used_list = &spD8->link;
			}
			if (cur_lvl->unk_10 == 0 && cur_lvl->unk_08 == 0 && yypvt[-0].identifier.unk_00 == 0) {
				UnkBeta* spD4;
				mk_parse_symb(yypvt[-0].identifier.unk_04, -1, B_10020F04);
				spD4 = (UnkBeta*)get_link_elem(B_10020F08);
				spD4->unk_04 = yypvt[-0].identifier.unk_04;
				spD4->link.next = B_10020F08->used_list;
				B_10020F08->used_list = &spD4->link;
				yyval.declarator.unk_04 = make(Id_decl, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
			} else {
				yyval.declarator.unk_04 = make(Id_decl, yypvt[-0].identifier.unk_08, yypvt[-0].identifier.unk_04);
			}
		} break;
case 173:
# line 1105 "src/7.1/cfe/c.y"
{
			yyval.declarator = yypvt[-1].declarator;
			cur_lvl->unk_04 = 1;
		} break;
case 174:
# line 1110 "src/7.1/cfe/c.y"
{
...
case 186:
# line 1227 "src/7.1/cfe/c.y"
{
			cur_lvl->unk_04 = 0;
			yyval.list.first = yyval.list.last = yypvt[-0].node;
		} break;
case 187:
# line 1232 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 188:
# line 1243 "src/7.1/cfe/c.y"
{
			cur_lvl->unk_04 = 0;
			yyval.list.first = yyval.list.last = yypvt[-0].node;
		} break;
case 189:
# line 1248 "src/7.1/cfe/c.y"
{
			cur_lvl->unk_04 = 0;
			yyval.list.first = yyval.list.last = yypvt[-0].node;
		} break;
case 190:
# line 1253 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 195:
# line 1297 "src/7.1/cfe/c.y"
{
			yyval.list.first = yyval.list.last = yypvt[-0].node;
		} break;
case 196:
# line 1301 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 200:
# line 1337 "src/7.1/cfe/c.y"
{
			yyval.node = make_topdecl(yypvt[-0].declspec.unk_00, yypvt[-0].declspec.unk_04, yypvt[-0].declspec.unk_08, NULL, yypvt[-0].declspec.unk_0C);
		} break;
case 201:
# line 1341 "src/7.1/cfe/c.y"
{
			yyval.node = make_topdecl(yypvt[-1].declspec.unk_00, yypvt[-1].declspec.unk_04, yypvt[-1].declspec.unk_08, yypvt[-0].node, yypvt[-1].declspec.unk_0C);
		} break;
case 204:
# line 1350 "src/7.1/cfe/c.y"
{
			TYPE_PUSH_BACK(yypvt[-0].node, yypvt[-1].node);
			yyval.node = yypvt[-0].node;
		} break;
case 205:
# line 1358 "src/7.1/cfe/c.y"
{
			yyval.node = yypvt[-1].node;
		} break;
case 206:
# line 1362 "src/7.1/cfe/c.y"
{
			yyval.node = make(Array_type, yypvt[-1].location, NULL);
		} break;
case 207:
# line 1366 "src/7.1/cfe/c.y"
{
			yyval.node = make(Array_type, yypvt[-2].location, yypvt[-1].node);
		} break;
case 208:
# line 1370 "src/7.1/cfe/c.y"
{
			yyval.node = make(Array_type, yypvt[-1].location, NULL);
...
case 218:
# line 1437 "src/7.1/cfe/c.y"
{ yyval.list.first = yyval.list.last = yypvt[-0].node; } break;
case 219:
# line 1439 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 227:
# line 1460 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-2].identifier.unk_04->name, yypvt[-2].identifier.unk_00);
			}
			yyval.node = make(Id_decl, yypvt[-2].identifier.unk_08, yypvt[-2].identifier.unk_04);
			yyval.node = make(Idlabeled_stmt, yypvt[-2].identifier.unk_08, yyval.node, yypvt[-0].node);
		} break;
case 228:
# line 1467 "src/7.1/cfe/c.y"
{ cur_lvl->unk_04 = 1; } break;
case 229:
# line 1468 "src/7.1/cfe/c.y"
{
			yyval.node = make(Id_decl, yypvt[-3].identifier.unk_08, yypvt[-3].identifier.unk_04);
			yyval.node = make(Idlabeled_stmt, yypvt[-3].identifier.unk_08, yyval.node, yypvt[-0].node);
		} break;
case 230:
# line 1473 "src/7.1/cfe/c.y"
{
			yyval.node = make(Caselabeled_stmt, yypvt[-3].identifier.unk_00, yypvt[-2].node, yypvt[-0].node);
		} break;
case 231:
# line 1477 "src/7.1/cfe/c.y"
{
			yyval.node = make(Defaultlabeled_stmt, yypvt[-2].identifier.unk_00, yypvt[-0].node);
		} break;
case 232:
# line 1484 "src/7.1/cfe/c.y"
{
...
case 237:
# line 1532 "src/7.1/cfe/c.y"
{ yyval.list.first = yyval.list.last = yypvt[-0].node; } break;
case 238:
# line 1534 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 239:
# line 1544 "src/7.1/cfe/c.y"
{ yyval.list.first = yyval.list.last = yypvt[-0].node; } break;
case 240:
# line 1546 "src/7.1/cfe/c.y"
{
			if (yyval.list.first == NULL) {
				yyval.list.first = yyval.list.last = yypvt[-0].node;
			} else if (yypvt[-0].node != NULL) {
...
case 241:
# line 1553 "src/7.1/cfe/c.y"
{ yyval.list.first = yyval.list.last = NULL; } break;
case 243:
# line 1559 "src/7.1/cfe/c.y"
{
			yyval.node = make(Expr_stmt, yypvt[-0].location, NULL);
		} break;
case 244:
# line 1563 "src/7.1/cfe/c.y"
{
			yyval.node = make(Expr_stmt, TREE_LOCATION(yypvt[-1].node), yypvt[-1].node);
		} break;
case 245:
# line 1570 "src/7.1/cfe/c.y"
{
			yyval.node = make(If_stmt, yypvt[-4].identifier.unk_00, yypvt[-2].node, yypvt[-0].node, NULL);
		} break;
case 246:
# line 1574 "src/7.1/cfe/c.y"
{
			yyval.node = make(If_stmt, yypvt[-6].identifier.unk_00, yypvt[-4].node, yypvt[-2].node, yypvt[-0].node);
		} break;
case 247:
# line 1578 "src/7.1/cfe/c.y"
{
			yyval.node = make(Switch_stmt, yypvt[-4].identifier.unk_00, yypvt[-2].node, yypvt[-0].node);
		} break;
case 248:
# line 1585 "src/7.1/cfe/c.y"
{
			yyval.node = make(While_stmt, yypvt[-4].identifier.unk_00, yypvt[-2].node, yypvt[-0].node);
		} break;
case 249:
# line 1589 "src/7.1/cfe/c.y"
{
			yyval.node = make(Dowhile_stmt, yypvt[-6].identifier.unk_00, yypvt[-5].node, yypvt[-2].node);
		} break;
case 250:
# line 1593 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-5].identifier.unk_00, NULL, NULL, NULL, yypvt[-0].node);
		} break;
case 251:
# line 1597 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-6].identifier.unk_00, NULL, NULL, yypvt[-2].node, yypvt[-0].node);
		} break;
case 252:
# line 1601 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-6].identifier.unk_00, NULL, yypvt[-3].node, NULL, yypvt[-0].node);
		} break;
case 253:
# line 1605 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-7].identifier.unk_00, NULL, yypvt[-4].node, yypvt[-2].node, yypvt[-0].node);
		} break;
case 254:
# line 1609 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-6].identifier.unk_00, yypvt[-4].node, NULL, NULL, yypvt[-0].node);
		} break;
case 255:
# line 1613 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-7].identifier.unk_00, yypvt[-5].node, NULL, yypvt[-2].node, yypvt[-0].node);
		} break;
case 256:
# line 1617 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-7].identifier.unk_00, yypvt[-5].node, yypvt[-3].node, NULL, yypvt[-0].node);
		} break;
case 257:
# line 1621 "src/7.1/cfe/c.y"
{
			yyval.node = make(For_stmt, yypvt[-8].identifier.unk_00, yypvt[-6].node, yypvt[-4].node, yypvt[-2].node, yypvt[-0].node);
		} break;
case 258:
# line 1628 "src/7.1/cfe/c.y"
{
			if (debug_arr['y'] > 0) {
				fprintf(dbgout, "IDENT=%s, was_typedef=%d\n", yypvt[-1].identifier.unk_04->name, yypvt[-1].identifier.unk_00);
			}
			yyval.node = make(Id_decl, yypvt[-1].identifier.unk_08, yypvt[-1].identifier.unk_04);
			yyval.node = make(Goto_stmt, yypvt[-2].identifier.unk_00, yyval.node);
		} break;
case 259:
# line 1636 "src/7.1/cfe/c.y"
{
			yyval.node = make(Continue_stmt, yypvt[-1].identifier.unk_00);
		} break;
case 260:
# line 1640 "src/7.1/cfe/c.y"
{
			yyval.node = make(Break_stmt, yypvt[-1].identifier.unk_00);
		} break;
case 261:
# line 1644 "src/7.1/cfe/c.y"
{
			yyval.node = make(Return_stmt, yypvt[-1].identifier.unk_00, NULL);
		} break;
case 262:
# line 1648 "src/7.1/cfe/c.y"
{
			yyval.node = make(Return_stmt, yypvt[-2].identifier.unk_00, yypvt[-1].node);
		} break;
case 263:
# line 1652 "src/7.1/cfe/c.y"
{
			yyval.node = make(Leave_stmt, yypvt[-1].identifier.unk_00);
		} break;
case 264:
# line 1659 "src/7.1/cfe/c.y"
{
			yyval.node = make(Try_stmt, yypvt[-6].identifier.unk_00, yypvt[-2].node, yypvt[-5].node, yypvt[-0].node);
		} break;
case 265:
# line 1663 "src/7.1/cfe/c.y"
{
			yyval.node = make(Try_stmt, yypvt[-3].identifier.unk_00, NULL, yypvt[-2].node, yypvt[-0].node);
		} break;
case 266:
# line 1669 "src/7.1/cfe/c.y"
{
...
case 270:
# line 1698 "src/7.1/cfe/c.y"
{
			error(0x2007F, LEVEL_DEFAULT, yypvt[-0].location);
			yyval.node = NULL;
		} break;
case 271:
# line 1703 "src/7.1/cfe/c.y"
{
			tree_handle = general_handle;
			yyval.node = NULL;
		} break;
case 272:
# line 1708 "src/7.1/cfe/c.y"
{
			yyval.node = make(Pragma, yypvt[-6].identifier.unk_00, (int)ICONSTANT(yypvt[-4].node).value, yypvt[-2].list);
		} break;
case 273:
# line 1712 "src/7.1/cfe/c.y"
{
			yyval.node = make(Pragma, yypvt[-4].identifier.unk_00, (int)ICONSTANT(yypvt[-2].node).value, NULL);
		} break;
case 274:
# line 1719 "src/7.1/cfe/c.y"
{
...
case 278:
# line 1771 "src/7.1/cfe/c.y"
{
			LINK_PUSH_BACK(yypvt[-0].node, yypvt[-1].list.first);
			yyval.node = yypvt[-0].node;
		} break;
case 279:
# line 1777 "src/7.1/cfe/c.y"
{  } break;
case 280:
