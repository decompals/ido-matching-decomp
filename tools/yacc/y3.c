...
static void precftn(r,t,s) int r,s,t;{ /* decide a shift/reduce conflict by precedence.
...
static void wdef( s, n ) char *s; int n; { /* output a definition of s to the value n */
