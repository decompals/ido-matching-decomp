...
def main():
    ...
    with open(file, "rb") as f:
        ...
        for i,sym in enumerate(dynsym_sec.iter_symbols()):
            dynsym = DynSym(i, sym.name, sym["st_info"]["type"], sym["st_shndx"], sym["st_value"], sym["st_size"])
            if i >= gotsym:
        ...
        print("Index, Value, Name, Section, Type, GOT index")
        for sym in symbols:
            ...
            print(f'{sym.index:4}, {sym.value:08X}, {padded_name} 0x{sym.size:X}, {section:8} {sym.type}', end="")
